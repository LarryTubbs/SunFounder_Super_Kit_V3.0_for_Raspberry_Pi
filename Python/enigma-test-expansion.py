...
while True:
    ...
    print('Reading input pins. 76543210 is the order:')
    i = bus.read_byte_data(MCP23017_ADDRESS,MCP23017_GPIOB)
    print("{0:08b}".format(i))
    time.sleep(0.5)
    
    #configue all PinA output high level
    print('Setting all A pins high...')
